...
<div class="login-box" style="">
  <div class="login-logo">
    <a href="#"><i class="fa fa-map-marker text-yellow"></i> <b>TravelCDO</b> Account</a>
  </div>
  <!-- /.login-logo -->
  <div class="" >
    <div class="card-body">
      ...
      <form action="{{ action('CustomerLoginController@store') }}" method="post">
         @csrf
      ...
      <p class="mb-0">
        <a class="btn btn-link"  href="{{ url('customer-register') }}">{{ __('Register') }} new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
