			<nav class="navbar navbar-default navbar-mobile navbar-fixed  bootsnav" style="background-color:#003580 ">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{ url('/') }}">
						<img src="{{ asset('agency/assets/img/logo.png') }}" class="logo logo-display" alt="">
