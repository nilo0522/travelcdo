...
<link rel="stylesheet" type="text/css" href="travelix/styles/bootstrap4/bootstrap.min.css">
<link href="travelix/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="travelix/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="travelix/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="travelix/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="travelix/styles/about_styles.css">
<link rel="stylesheet" type="text/css" href="travelix/styles/about_responsive.css">

<script src="travelix/js/jquery-3.2.1.min.js"></script>
<script src="travelix/styles/bootstrap4/popper.js"></script>
<script src="travelix/styles/bootstrap4/bootstrap.min.js"></script>
<script src="travelix/plugins/greensock/TweenMax.min.js"></script>
<script src="travelix/plugins/greensock/TimelineMax.min.js"></script>
<script src="travelix/plugins/scrollmagic/ScrollMagic.min.js"></script>
<script src="travelix/plugins/greensock/animation.gsap.min.js"></script>
<script src="travelix/plugins/greensock/ScrollToPlugin.min.js"></script>
<script src="travelix/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="travelix/plugins/easing/easing.js"></script>
<script src="travelix/plugins/parallax-js-master/parallax.min.js"></script>
<script src="travelix/js/about_custom.js"></script>
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">travelcdo</a></div>
						</div>
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="{{'home'}}">home</a></li>
								<li class="main_nav_item"><a href="{{'gabout'}}">about us</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="intro_content">
						...
						<p class="intro_text">Travel CDO  Agency is a travel ticketing agency located in Julio Pacana Street Licuan Cagayan de Oro City that can offer you great and convenient services to you, and your friends and family! We offer Domestic Airline Ticketing, Hotel Reservatin, Car Rentals and Tours Packages.

							Travel CDO Agency caters to both group and individual clients. We offer complete local arrangements at very competitive prices</p>
						<div class="button intro_button"><div class="button_bcg"></div><a href="{{'home'}}">explore now<span></span><span></span><span></span></a></div>
					</div>
				</div>
			</div>
		</div>
