...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-tachometer-alt"></i><span></span> Dashboard</h1>
          </div>
          <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-3 col-6">
        <div class="small-box" style="background-color: #0000CC ">
          <div class="inner text-white text-bold">
            <h3>{{$count}}</h3>
            <p>Rooms</p>
          </div>
          <div class="icon">
          ...
          <a href="{{url('admin/rooms')}}" class="small-box-footer">More info <i class="fa fa-arrow-right"></i>
          </a>
        </div>
      </div>
      <div class="col-lg-3 col-6 text-white">
        <div class="small-box" style="background-color: #00CC33 ">
          <div class="inner">
            <h3>{{ $book }}</h3>
            <p class="text-bold ">Booking</p>
          </div>
          <div class="icon">
            <i class="fa fa-suitcase"></i>
          </div>
          <a href="{{ url('admin/reservation-list') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i>
          </a>
        </div>
      </div>
      <div class="col-lg-3 col-6 ">
            <div class="small-box bg-warning">
              ...
              <a href="{{ url('admin/reservation-pending') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
      </div>
       <div class="col-lg-3 col-6 ">
            <div class="small-box bg-success">
              <div class="inner text-white">
                <h3>{{ $confirm }}</h3>
                <p class="text-bold">Confirmed</p>
              </div>
              <div class="icon">
                <i class="fa fa-check-circle"></i>
              </div>
              <a href="{{ url('admin/reservation-manage-confirmed') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
      </div>
      <div class="col-lg-3 col-6">
        <div class="small-box bg-primary">
          ...
          <a href="{{ url('admin/reservation-manage-checkin') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <div class="col-lg-3 col-6">
      ...
      <div class="col-lg-3 col-6">
        <div class="small-box" style="background-color: #E74C3C">
          <div class="inner text-white">
            <h3>0</h3>
            <p class="text-bold">Cancelled Booking</p>
          </div>
          <div class="icon">
    ...
    <section class="content ">
      <div class="card">
        <div class="card-header">
              <h3 class="card-title"><b>Reservation List</b></h3>

            </div>
              <div class="card-body">
               
                
                <table id="tblr" class="table table-hover table-striped table-bordered text-sm"> 
                  <thead>
                  <tr>
                    <th width="5px">No.</th>
                    <th >Guest</th>
                ...
                @endphp
                   @foreach($res_all as  $res) 
                    ...
                    @foreach($customer as $c)
                      @if($res->room_id==$r->id && $res->cus_id == $c->id )
