                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active">Reservation/<a href="{{ url('admin/reservation-pending') }}">{{ session('status') }}</a></li>
                    </ol>
                  </div>
                </div>
              </div><!-- /.container-fluid -->
                 ...
                 <tr>
                   ...
                   <td>₱ {{ number_format($res->total) }}</td>
                    ...
                    <span class="badge badge-primary">{{ $res->book_status }}</span> 
                     ...
                     <td>
                       <form method="post" action="{{ action('AdminManageController@destroy',$res->id) }}">
                        @method('delete')
